import json
from  arsing.command_creator import CommandCreator

json_path = "JSONS/Commands/El_encoder_correction_constants_module.json"
...
def str_get_El_encoder_correction_zona_number():
    return create_El_enc_crct_get_command("str_get_El_encoder_correction_zona_number")
def str_get_El_encoder_correction_member(data):
    return create_El_enc_crct_set_command("str_get_El_encoder_correction_member", data)
