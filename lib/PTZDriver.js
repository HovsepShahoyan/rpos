...
// function setZooming(funcCurrentDayZoom) {
//     currentDayZoom = funcCurrentDayZoom;
//     CommandClient.setDayZoomForPTZ(currentDayZoom);
//     if (currentDayZoom == 4) {
//         currentIRZoom = 2;
//         CommandClient.setZoomPTZ(currentIRZoom);
//     }
        ...
        this.process_ptz_command = function (command, data) {
            ...
            if (command === 'gotohome') {
                ...
                if (_this.pelcod) {
                    ...
                    if (z > 0) {
                        if (currentDayZoom < 6 && currentDayZoom >= 1) {
                            currentDayZoom = currentDayZoom + 1;
                            if (currentDayZoom >= 4) {
                            currentIRZoom = currentIRZoom + 1;
                            console.log("Current IR zoom: ", currentIRZoom);
                            CommandClient.setZoomPTZ(currentIRZoom);
                        }
                        }
                        CommandClient.setDayZoomForPTZ(currentDayZoom);
                ...
                console.log("---------: p and t converted", xcoord, ycoord, currentDayZoom)

                doubleClick.onDoubleClick(xcoord, ycoord, currentDayZoom);
                try {
                    p = parseFloat(data.pan);
                }
                catch (err) { }
