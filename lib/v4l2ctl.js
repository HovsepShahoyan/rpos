...
(function (v4l2ctl) {
    ...
    v4l2ctl.Controls = {
        UserControls: {
            ...
            digital_zoom: new UserControl(1, { range: { min: 1, max: 4 }, controlType: "Range"  }),
            day_zoom: new UserControl(1, { range: { min: 1, max: 68 }, controlType: "Range"  }),
            ...
            deg_enc_movement_el: new UserControl(1, { range: { min: -185, max: 185 }, controlType: "Range"  }),
