...
(function (v4l2ctl) {
    ...
    v4l2ctl.Controls = {
        UserControls: {
            ...
            codec: new UserControl(0, { lookupSet: [{ value: 0, desc: 'h265' }, { value: 1, desc: 'h264' }, { value: 2, desc: 'mpeg'}] }),
            ...
            default_configuration: new UserControl(false, {
                controlType: "Button",
        ...
        try {
            ...
            if (cmd.includes('codec')) {
                ...
                if (codec == 1) {
                    ...
                    global.cmdClient.setCodecToMPEG(codec);
                }
                else {
            ...
            if (cmd.includes('configuration')) {
                //const defaultConfig = cmd.split('=')[1];
                console.log(`[V4L2] Default Configuration extracted`);

                global.cmdClient.setDefaultConfiguration();
            }
