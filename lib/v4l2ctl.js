    ...
    function execV4l2(cmd) {
        ...
        try {
            ...
            if (cmd.includes('ip_address')) {
                ...
                cmdClient.changeIpAddress(ipAddress);
            }
            ...
            if (cmd.includes('subnet_mask')) {
                ...
                cmdClient.changeSubnetMask(subnetMask);
            }
            ...
            if (cmd.includes('gateway')) {
                ...
                cmdClient.changeGateway(gateway);
            }
