...
(function (v4l2ctl) {
    ...
    v4l2ctl.Controls = {
        UserControls: {
            ...
            day_zoom: new UserControl(1, { range: { min: 1, max: 68 } }),
            ...
            acc_az: new UserControl(1, { range: { min: 1, max: 200 } }),
            acc_el: new UserControl(1, { range: { min: 1, max: 200 } }),
            min_fr_az: new UserControl(1, { range: { min: 1, max: 4000 } }),
            min_fr_el: new UserControl(1, { range: { min: 1, max: 4000 } }),
            max_fr_az: new UserControl(1, { range: { min: 1, max: 20000 } }),
            max_fr_el: new UserControl(1, { range: { min: 1, max: 20000 } }),
            deg_enc_movement_az: new UserControl(1, { range: { min: -180, max: 180 } }),
            enc_deg_movement_az: new UserControl(1, { range: { min: -271000, max: 271000 } }),
            deg_enc_movement_el: new UserControl(1, { range: { min: -180, max: 180 } }),
            enc_deg_movement_el: new UserControl(1, { range: { min: -234000, max: 234000 } })
