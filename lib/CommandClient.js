...
class CommandClient {
    ...
    setUp(value) {
        console.log('[CommandClient] PTZ Up command:', value); 
    }

    setDown(value) {
        console.log('[CommandClient] PTZ Down command:', value);        
    }

    setRight(value) {
        console.log('[CommandClient] PTZ Right command:', value);
    }

    setLeft(value) {
        console.log('[CommandClient] PTZ Left command:', value);
    }
