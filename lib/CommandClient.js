...
class CommandClient {
    ...
    getInclinationData() {
        if (this.latestClientData && this.latestClientData.properties) {
            const { incl_t, incl_X_ag, incl_Y_ag, T_incl_X_ag, T_incl_Y_ag } = this.latestClientData.properties;
            return {
                incl_t,
                incl_X_ag,
                incl_Y_ag,
    ...
    getGPSData() {
        if (this.latestClientData1 && this.latestClientData1.properties) {
            const { GPS_S, GPS_0, GPS_1, GPS_2, GPS_3, GPS_4, GPS_5, GPS_6 } = this.latestClientData1.properties;
            return {
                GPS_S,
                GPS_0,
                GPS_1,
    ...
    getSTMDData() {
        if (
            ...
            const { curr_pos_Az, curr_pos_El, Encoder_Az, Encoder_El } = this.latestClientData1.properties;
            return { curr_pos_Az, curr_pos_El, Encoder_Az, Encoder_El };
        }
        else {
            return {}; 
        }
