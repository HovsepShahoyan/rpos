    ...
    constructor() {
        ...
        this.client.on('data', (data) => {
            ...
            if (parsed.mode == "LRF_LRX20A") {
                ...
                console.log("Latest Inclination Data (Sns_OD):", this.latestInclinationData);
                ...
                const encoderAzZero = 131000;  // confirmed zero offset
                const incliX = parseFloat(parsed.incl_X_ag || 0) / 1000.0;
                const incliY = parseFloat(parsed.incl_Y_ag || 0) / 1000.0;
            
                // Temporary fallback values until real calibration data is known
                ...
                //const compassOffset = parseFloat(parsed.CC_cmps_ofst || 0);
                ...
                // Print to console to verify all data correctness
                console.log("✅ Computed Angles:");
                console.log("Azimuth AngleD:", alphaDStr, "(", parseFloat(alphaD.angleDegrees.toFixed(3)), "° )");
                console.log("Elevation MestoC:", mestoCStr, "(", parseFloat(mestoC.angleDegrees.toFixed(3)), "° )");
            }
            else {
                this.latestClientData = parsed;
