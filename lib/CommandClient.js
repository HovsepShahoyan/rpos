...
class CommandClient {
    constructor() {
        ...
        this.alphaD1Button = 0;
        this.alphaD2Button = 0;
    ...
    northConnectWithButton() {
        this.encoderAzZeroFlag = true;
        this.alphaD1 = this.alphaD1Button;
        this.alphaD2 = this.alphaD2Button;
        console.log("((((((((((((((((((())))))))))))))))))))))Entered northConnect")
        console.log("alphaD1 alphaD2 azimuthDeg", /*(Float(this.azimuthDeg) * 6), */Number(this.alphaD1), Number(this.alphaD2) / 100, (Number(this.alphaD1) + Number(this.alphaD2) / 100) * 6)
        const encoderAzZero = ((Number(this.azimuthDeg) * 6) - ((Number(this.alphaD1) + Number(this.alphaD2) / 100) * 6));
        console.log("Connecting to north by encoderAzZero", this.encoderAzZero)
    ...
    writeOverlay(zeroOffset) {
        ...
        this.alphaD1Button = azArt.angleDirectionalBeforeDot;
        this.alphaD2Button = azArt.angleDirectionalAfterDot;
    ...
    changeIpAddress(value) {
        this.ipAddress = value;
        console.log('Changing Ip address to :', this.ipAddress);
    }

    changeSubnetMask(value) {
        this.subnetMask = value;
        console.log('Changing Subnet Mask to :', this.subnetMask);
    }

    changeGateway(value) {
        this.gateway = value;
        console.log('Changing Gateway to :', this.gateway);
    }

    changeDNS1(value) {
        this.dns1 = value;
        console.log('Changing DNS1 to :', this.dns1);
    }

    changeDNS2(value) {
        this.dns2 = value;
        console.log('Changing DNS2 to :', this.dns2);
    }
    ...
    getCrctEncoderAz() {
        console.log("AAAAAAAAAAAAAAAAAA", this.stmdAzimuth)
        return this.stmdAzimuth;
    }

    getCrctEncoderEl() {
        console.log("BBBBBBBBBBBBB", this.stmdEncoder)
