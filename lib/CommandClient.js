...
class CommandClient {
    constructor() {
        ...
        this.HOST = '192.168.0.55';
        this.PORT = 2222;
        this.HOST1 = '192.168.0.55';
        this.PORT1 = 8888;
    ...
    setAlphaD2(value) {
        //this.alphaD2 = value;
        console.log('[CommandClient] Setting AlphaD2 to :', value); 
    }
    ...
    setResolution(value) {
        ...
        exec('pkill -f gst-rtsp-launch.py', (err) => {
            ...
            // Restart the process (adjust path as needed)
    ...
    northConnectByXY(cameraX, cameraY, targetX, targetY) {
        // Calculate azimuth angle from camera to target
