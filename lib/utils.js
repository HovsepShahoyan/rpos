...
(function (Utils) {
    ...
    var DummyProcess = (function (_super) {
        ...
        function DummyProcess() {
            ...
            _this.stdin = new stream_1.Writable();
            _this.stderr = _this.stdout = new DummyReadable();
            return _this;
        }
        DummyProcess.prototype.kill = function (signal) { return true; };
        ;
        DummyProcess.prototype.send = function (message, sendHandle) { return true; };
        ;
        DummyProcess.prototype.disconnect = function () { };
        ;
        DummyProcess.prototype.unref = function () { };
        ;
        DummyProcess.prototype.ref = function () { };
        ;
        return DummyProcess;
    ...
    var utils = (function () {
        ...
        utils.testIpAddress = function () {
            var ip, interfaces = (0, os_1.networkInterfaces)();
        ...
        utils.spawn = function (cmd, args, options) {
            utils.log.debug("spawn('".concat(cmd, "', [").concat(args.join(), "], ").concat(options, ")"));
            if (utils.notPi()) {
        ...
        utils.log = {
            ...
            error: function (message) {
                ...
                if (utils.log.level > logLevel.None) {
                    ...
                    console.log.apply(this, __spreadArray([message], args, true));
                }
            },
