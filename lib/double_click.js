    ...
    if (lastPresetClick === i) {
      try {
        ...
        if (pos && pos.az != null && pos.el != null && parseInt(pos.zoomDay) != null && parseInt(pos.zoomIR) != null) {
          global.currentIRZoom = pos.irZoom;
          global.currentDayZoom = pos.dayZoom;
          CommandClient.setMarkerPosition(pos.az, pos.el, parseInt(pos.zoomDay), parseInt(pos.zoomIR));
        }
      } catch (err) {
