...
function calculateNewPositionEncoderCrosshair(clickX, clickY, screenWidth, screenHeight,
  ...
  xCrossPos = CommandClient.getEncCrctZoomAz(1);
  yCrossPos = CommandClient.getEncCrctZoomEl(1);
  ...
  console.log("angleOffsetH angleOffsetV", angleOffsetH, angleOffsetV)
  ...
  console.log("HOVOI log horiz vert: ", newHorizontal, newVertical)
