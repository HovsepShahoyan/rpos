...
function onDoubleClick(x, y, zoom) {
  ...
  if (zoomFlagForDigitalZoom && zoom != 6) {
      zoomVariable = Math.round((zoomVariable - 0.2) * 10) / 10; 
  ...
  // 4) Network Config button (Toggle Network) 
