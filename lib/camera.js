...
var Camera = (function () {
    ...
    Camera.prototype.getSettingsPage = function (filePath, callback) {
        ...
        fs.readFile(filePath, function (err, content) {
            ...
            var parseControls = function (html, displayname, propname, controls) {
                ...
                let ptzButtons = { up: '', down: '', left: '', right: '', middle: '' };
                let focusMinus = "", focusPlus = "";
                let zoomMinus = "", zoomPlus = "";
                ...
                for (var uc in controls) {
                    ...
                    if (p.controlType === "Button") {
                        if (lowerLabel.includes("ptz up")) { ptzButtons.up = createPTZButton(propname, uc, "↑"); continue; }
                        if (lowerLabel.includes("ptz down")) { ptzButtons.down = createPTZButton(propname, uc, "↓"); continue; }
                        if (lowerLabel.includes("ptz left")) { ptzButtons.left = createPTZButton(propname, uc, "←"); continue; }
                        if (lowerLabel.includes("ptz right")) { ptzButtons.right = createPTZButton(propname, uc, "→"); continue; }
                        if (lowerLabel.includes("ptz middle")) { ptzButtons.middle = createPTZButton(propname, uc, "⏺"); continue; }
                    ...
                    if (p.controlType === "Range") {
                        ...
                        html += `<tr><td><span class="label">${uc}</span></td>
                            <td><input type="range" name="${propname}.${uc}" min="${range.min}" max="${range.max}" value="${p.value}"
                            oninput="this.nextElementSibling.value = this.value" />
                            <output>${p.value}</output></td></tr>`;
                        continue;
                    }
            
                    // Default input
                    html += `<tr><td><span class="label">${uc}</span></td><td>
    ...
    function generateMouseEvents(prop, uc) {
        return `
            onmousedown="(function(){ const f=document.createElement('form');f.method='POST';f.action='/';const i=document.createElement('input');i.type='hidden';i.name='${prop}.${uc}';i.value=true;f.appendChild(i);document.body.appendChild(f);f.submit(); })()"
            onmouseup="(function(){ const f=document.createElement('form');f.method='POST';f.action='/';const i=document.createElement('input');i.type='hidden';i.name='${prop}.${uc}';i.value=false;f.appendChild(i);document.body.appendChild(f);f.submit(); })()"
            ontouchstart="(function(){ const f=document.createElement('form');f.method='POST';f.action='/';const i=document.createElement('input');i.type='hidden';i.name='${prop}.${uc}';i.value=true;f.appendChild(i);document.body.appendChild(f);f.submit(); })()"
            ontouchend="(function(){ const f=document.createElement('form');f.method='POST';f.action='/';const i=document.createElement('input');i.type='hidden';i.name='${prop}.${uc}';i.value=false;f.appendChild(i);document.body.appendChild(f);f.submit(); })()"
        `;
    }

    var html = `
        <style>
            body { background-color: #121212; color: #f1f1f1; font-family: 'Segoe UI', sans-serif; }
            .settings-table { width: 100%; background-color: #1e1e1e; color: #eee; border-collapse: collapse; border: 1px solid #333; }
...
.ptz-key:hover {
    ...
    `;
        html += `
            ...
            <h1>Aragats - ONVIF NVT Camera</h1>
            `;
               ...
               <form method="POST" action="/">
                 ...
                 <div class="stmd-movement-container">
                   <table class="settings-table">
                     ...
                     <tbody id="stmdTable">
                       <tr><td>currentPosAz</td><td><input type="text" value="..." readonly /></td></tr>
                       <tr><td>currentPosEl</td><td><input type="text" value="..." readonly /></td></tr>
                       <tr><td>EncoderAz</td><td><input type="text" value="..." readonly /></td></tr>
                       <tr><td>EncoderEl</td><td><input type="text" value="..." readonly /></td></tr>
                     </tbody>
                   </table>
                   ...
                   <table class="settings-table">
                     ...
                     <tbody id="movementTable">
                       <tr><td>DegreesAz</td><td><input type="text" value="..." readonly /></td></tr>
                       <tr><td>EncoderAz</td><td><input type="text" value="..." readonly /></td></tr>
                       <tr><td>DegreesEl</td><td><input type="text" value="..." readonly /></td></tr>
                       <tr><td>EncoderEl</td><td><input type="text" value="..." readonly /></td></tr>
                     </tbody>
                   </table>
                 </div>
             ...
             <div class="right-panel">
               <table class="settings-table">
                 ...
                 <tbody id="inclinoTable">
                   <tr><td>incl_t</td><td><input type="text" value="..." readonly /></td></tr>
                   <tr><td>incl_X_ag</td><td><input type="text" value="..." readonly /></td></tr>
                   <tr><td>incl_Y_ag</td><td><input type="text" value="..." readonly /></td></tr>
                 </tbody>
