    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li><a class="nav-link" data-page="ptz">PTZ</a></li>
    ...
    <main class="main-container">
        ...
        <div id="controls-page" class="page-content active">
            <div class="page-header">
                <h1 class="page-title">Camera Controls</h1>
                <p class="page-subtitle">Adjust camera parameters and user controls</p>
            </div>
        ...
        <div id="ptz-page" class="page-content">
            <div class="page-header">
                <h1 class="page-title">PTZ Control</h1>
                <p class="page-subtitle">Pan, Tilt, and Zoom camera control</p>
            </div>

            <div class="grid-container">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Direction Control</h3>
                    </div>
                    <div class="ptz-container">
                        <div class="ptz-grid">
                            ...
                            <button type="button" class="ptz-btn">↗</button>
                            <button type="button" class="ptz-btn">←</button>
                            <button type="button" class="ptz-btn ptz-center">⦿</button>
                            <button type="button" class="ptz-btn">→</button>
                            <button type="button" class="ptz-btn">↙</button>
                            <button type="button" class="ptz-btn">↓</button>
                            <button type="button" class="ptz-btn">↘</button>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Zoom & Focus</h3>
                    </div>
                    <div class="settings-table">
                        <div class="settings-row">
                            <div class="settings-label">Focus Control</div>
                            <div class="btn-group">
                                <button type="button" class="btn btn-secondary">Near Focus</button>
                                <button type="button" class="btn btn-secondary">Far Focus</button>
                                <button type="button" class="btn btn-primary">Auto Focus</button>
                            </div>
                        </div>
                        <div class="settings-row">
                            <div class="settings-label">Zoom Control</div>
                            <div class="btn-group">
