            ...
            var parseControls = function (html, displayname, propname, controls) {
                ...
                for (var uc in controls) {
                    ...
                    if (p.hasSet) {
                        ...
                        let buttonLabel = p.options.label || uc;
                        let isPTZ = false;
                    
                        if (buttonLabel.toLowerCase().includes('ptz up')) {
                            buttonLabel = '⬆️'; isPTZ = true;
                        } else if (buttonLabel.toLowerCase().includes('ptz down')) {
                            buttonLabel = '⬇️'; isPTZ = true;
                        } else if (buttonLabel.toLowerCase().includes('ptz left')) {
                            buttonLabel = '⬅️'; isPTZ = true;
                        } else if (buttonLabel.toLowerCase().includes('ptz right')) {
                            buttonLabel = '➡️'; isPTZ = true;
                        } else if (buttonLabel.toLowerCase().includes('ptz middle')) {
                            buttonLabel = '⏺'; isPTZ = true;
                        }
                        else {
                            buttonLabel = 'Press';
                        }
                        ...
                        // Only include label column if not PTZ
                        if (!isPTZ) {
                            html += `<td><span class="label">${p.options.label || uc}</span></td>`;
                        } else {
                            html += `<td></td>`;
                        }
                    
                        html += `<td>
                            <button type="button" style="font-size: 0.75em;"
                        ...
                        html += `<tr><td><span class="label">${uc}</span></td>
                            <td>
                                <input type="range"
                                       ...
                                       style="width: 200px;" />
                                <output style="margin-left: 10px;">${p.value}</output>
                            </td></tr>`;
                    }
           ...
           <div class="telemetry-layout">
             <div class="left-panel">
               <form method="POST" action="/">
                 ...
                 <!-- STMD and Movement side-by-side -->
                 <div class="stmd-movement-container">
                   <table class="stmd-block">
                     <tr><td colspan="2"><strong>STMD Data</strong></td></tr>
                     <tbody id="stmdTable">
                   ...
                   <table class="movement-block">
                     <tr><td colspan="2"><strong>Movement Data</strong></td></tr>
             ...
             <div class="right-panel">
               <table>
                 <tr><td colspan="2"><strong>Inclination Data</strong></td></tr>
                 ...
                 <tr><td colspan="2"><strong>GPS Data</strong></td></tr>
                 <tbody id="gpsTable">
