...
<div id="map-page" class="page-content">
  <div class="page-header">
    ...
    <p class="page-subtitle">Local map tiles (zoom 1–12)</p>
  </div>
  ...
  var relY = 0.5 - (clickY / screenHeight);
    ...
    <script>
        ...
        function initLocalMap() {
          ...
          // tile url template served by express: /maptiles/{z}/{x}/{y}.png
          const tileTemplate = window.location.origin + '/maptiles/{z}/{x}/{y}.png';

          // If your tiles have a different extension (jpg), change the template above.
          localMapInstance = new mapboxgl.Map({
            ...
            center: [44.5, 40.2], // set reasonable default lon/lat (adjust to your area)
            zoom: 5,              // default zoom
            minZoom: 1,
            maxZoom: 12
          });
