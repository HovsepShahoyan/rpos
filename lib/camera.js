            ...
            var parseControls = function (html, displayname, propname, controls) {
                ...
                for (var uc in controls) {
                    ...
                    if (p.controlType === "Button") {
                        ...
                        if(lowerLabel.includes("download_screemshot")) {
                            html += `<tr>
                                    <td><span class="label">${label}</span></td>
                                    <td><button type="button" class="standard-button" ${generateMouseEvents(propname, uc)}>Ethernet Set</button></td>
                                    </tr>`; 
             ...
             <div class="left-panel">
               <form method="POST" action="/" onsubmit="event.preventDefault();">
                ...
                <table class="settings-table">
                    ...
                    <tbody id="stmdTable">
                    <tr><td title="currentPosAz">CurrentPositionOfAzimuthInSteps</td><td><input type="text" value="..." readonly /></td></tr>
                    <tr><td title="currentPosEl">CurrentPositionOfElevationInSteps</td><td><input type="text" value="..." readonly /></td></tr>
                    <tr><td title="EncoderAz">EncoderAzimuth</td><td><input type="text" value="..." readonly /></td></tr>
                    <tr><td title="EncoderEl">EncoderElevation</td><td><input type="text" value="..." readonly /></td></tr>
                    </tbody>
                </table>
                ...
                <table class="settings-table">
                    ...
                    <tr><td title="DegreesAz">DegreeAzimuth</td><td><input type="text" value="..." readonly /></td></tr>
                    <tr><td title="EncoderAz">EncoderAzimuth</td><td><input type="text" value="..." readonly /></td></tr>
                    <tr><td title="DegreesEl">DegreeElevation</td><td><input type="text" value="..." readonly /></td></tr>
                    <tr><td title="EncoderEl">EncoderElevation</td><td><input type="text" value="..." readonly /></td></tr>
                    </tbody>
                </table>
                </div>
                ...
                <table class="settings-table">
                    ...
                    <tr><td title="incl_X_ag">InclinationX</td><td><input type="text" value="..." readonly /></td></tr>
                    <tr><td title="incl_Y_ag">InclinationY</td><td><input type="text" value="..." readonly /></td></tr>
                    </tbody>
