...
var Camera = (function () {
    ...
    Camera.prototype.getSettingsPage = function (filePath, callback) {
        ...
        fs.readFile(filePath, function (err, content) {
            ...
            html += `
            <tr><td colspan="2"><strong>Live Telemetry Data</strong></td></tr>
            ...
            <tbody id="inclinoTable">
              ...
              <tr><td>T_incl_X_ag</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>T_incl_Y_ag</td><td><input type="text" value="..." readonly /></td></tr>
            </tbody>
            
            <tr><td colspan="2"><strong>GPS Data</strong></td></tr>
            <tbody id="gpsTable">
              <tr><td>GPS_S</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>GPS_0</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>GPS_1</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>GPS_2</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>GPS_3</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>GPS_4</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>GPS_5</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>GPS_6</td><td><input type="text" value="..." readonly /></td></tr>
            </tbody>

            <tr><td colspan="2"><strong>STMD Data</strong></td></tr>
            <tbody id="stmdTable">
              <tr><td>curr_pos_Az</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>curr_pos_El</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>Encoder_Az</td><td><input type="text" value="..." readonly /></td></tr>
              <tr><td>Encoder_El</td><td><input type="text" value="..." readonly /></td></tr>
            </tbody>
