        ...
        discover_socket.on('message', function (received_msg, rinfo) {
            ...
            parseString(filtered_msg, { tagNameProcessors: [strip] }, function (err, result) {
                ...
                if (probe_type === "" || probe_type.indexOf("NetworkVideoTransmitter") > -1) {
                    var reply = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n          <SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:wsa=\"http://schemas.xmlsoap.org/ws/2004/08/addressing\" xmlns:d=\"http://schemas.xmlsoap.org/ws/2005/04/discovery\" xmlns:dn=\"http://www.onvif.org/ver10/network/wsdl\">\n            <SOAP-ENV:Header>\n              <wsa:MessageID>uuid:".concat(uuid.v1(), "</wsa:MessageID>\n              <wsa:RelatesTo>").concat(probe_uuid, "</wsa:RelatesTo>\n              <wsa:To SOAP-ENV:mustUnderstand=\"true\">http://schemas.xmlsoap.org/ws/2004/08/addressing/role/anonymous</wsa:To>\n              <wsa:Action SOAP-ENV:mustUnderstand=\"true\">http://schemas.xmlsoap.org/ws/2005/04/discovery/ProbeMatches</wsa:Action>\n              <d:AppSequence SOAP-ENV:mustUnderstand=\"true\" MessageNumber=\"68\" InstanceId=\"1460972484\"/>\n            </SOAP-ENV:Header>\n            <SOAP-ENV:Body>\n              <d:ProbeMatches>\n                <d:ProbeMatch>\n                  <wsa:EndpointReference>\n                    <wsa:Address>urn:uuid:").concat(utils.uuid5(utils.getIpAddress() + _this.config.ServicePort + _this.config.RTSPPort), "</wsa:Address>\n                  </wsa:EndpointReference>\n                  <d:Types>dn:NetworkVideoTransmitter</d:Types>\n                  <d:Scopes>\n                    onvif://www.onvif.org/type/video_encoder\n                    onvif://www.onvif.org/type/ptz\n                    onvif://www.onvif.org/hardware/").concat(encodeURIComponent(_this.config.DeviceInformation.Model), "\n                    onvif://www.onvif.org/name/").concat(encodeURIComponent(_this.config.DeviceInformation.Manufacturer + ' ' + _this.config.DeviceInformation.Model), "\n                    onvif://www.onvif.org/location/\n                  </d:Scopes>\n                  <d:XAddrs>http://").concat(utils.getIpAddress(), ":").concat(_this.config.ServicePort, "/onvif/device_service</d:XAddrs>\n                  <d:MetadataVersion>1</d:MetadataVersion>\n              </d:ProbeMatch>\n              </d:ProbeMatches>\n            </SOAP-ENV:Body>\n          </SOAP-ENV:Envelope>");
